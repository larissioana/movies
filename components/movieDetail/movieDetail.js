...
return (
        ...
        <div className={styles.movieContent} style={{
        ...
        <p className={styles.vote}>
         ...
         {poster_path ? 
         <Image src={IMAGE_URL + poster_path} width='300' height='400' alt={title} className={styles.posterPath}/>
         :
         <Image src='/static/image.jpg' alt={title}  width='300' height='400' className={styles.cardImg}/>
        }
        </div>
        </div>
        </div>
